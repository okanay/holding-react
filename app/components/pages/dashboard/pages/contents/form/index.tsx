...
import { CONTENT_CATEGORY_OPTIONS, LANGUAGE_OPTIONS } from "./config";
                  ...
                  hint={
                    (
                      <div className="space-y-2 text-xs text-zinc-600">
                        ...
                        <div>
                          Farklı dillerdeki içeriklerin birbirine bağlanabilmesi
                          için identifier alanı aynı olmalıdır.
                        </div>
                      </div>
                    ) as any
                  }
